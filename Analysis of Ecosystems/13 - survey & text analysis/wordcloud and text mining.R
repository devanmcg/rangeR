...
pacman::p_load(devtools, twitteR, ROAuth, RCurl, stringr, tm, plyr, dplyr, quanteda, qdap, wordcloud, RQDA) 
...
URL <- "https://github.com/thefactmachine/hex-binning-gis-data/raw/master/popDensity.RData"
load(url(githubURL))
